              ...
              <div className="d-flex align-items-center h-custom-2 ms-xl-4 pt-5 pt-xl-0 mt-xl-n5" >
                ...
                <form className='w-100 mb-5' >
                  ...
                  <div className="form-outline mb-5">
                    <input type="email"  className="form-control form-control-sm w-75 shadow-none p-2" placeholder='Enter email id'/>
                    
                  </div>
      
                  <div className="form-outline mb-5">
                    <input type="password" className="form-control form-control-sm w-75 shadow-none p-2" placeholder='Enter password'/>
                  </div>
      
                  <div className="pt-1 mb-4">
                    <button className="btn btn-info btn-sm btn-block w-75 shadow-none" type="button">Login</button>
                  </div>
